...
class Set:
    ...
    @staticmethod
    def from_array(list: list) -> Set:
        raise NotImplementedError("Method from_array(list) is not implemented")
    ...
    def diff_element(self, b) -> Set:
        raise NotImplementedError(
            "Method diff_element(self, SetElement) is not implemented")
    ...
    def intersect(self, b: Set) -> Set:
        raise NotImplementedError(
            "Method intersect(self, Set) is not implemented")

    def intersect_count(self, b: Set) -> int:
        raise NotImplementedError(
            "Method intersect_count(self, Set) is not implemented")
    ...
    def union_element(self, b) -> Set:
        raise NotImplementedError(
            "Method union_element(self, SetElement) is not implemented")

    def union_count(self, b: Set) -> int:
        raise NotImplementedError(
            "Method union_count(self, Set) is not implemented")
    ...
    def cardinality(self) -> int:
        raise NotImplementedError(
            "Method cardinality(self) is not implemented")
